...
describe('Tests for adminQuizTrashEmpty', () => {
  ...
  test('Token is Invalid', () => {
    ...
    const quizIndex = adminQuizCreateRequest(newUser.token, 'Test Quiz 1', 'This is a test');
    expect(adminQuizRemoveRequest(newUser.token, quizIndex.quizId)).toEqual({});
    expect(adminQuizTrashEmptyRequest('', quizIndex.quizId)).toEqual(ERROR);
  });
  ...
  test('QuizId is Invalid', () => {
    ...
    const quizIndex = adminQuizCreateRequest(newUser.token, 'Test Quiz 2', 'This is a test');
    expect(adminQuizRemoveRequest(newUser.token, quizIndex.quizId)).toEqual({});
    expect(adminQuizTrashEmptyRequest(newUser.token, quizIndex.quizId + 1)).toEqual(ERROR);
  });
  ...
  test('Quiz is not owned by the owner', () => {
    ...
    expect(adminQuizTrashEmptyRequest(newUser2.token, quizIndex.quizId)).toEqual(ERROR);
  });
  ...
  test('Deleting one quiz, Normal Case', () => {
    ...
    expect(adminQuizRemoveRequest(newUser.token, quizIndex.quizId)).toEqual({});
    // Empty trash
    expect(adminQuizTrashEmptyRequest(newUser.token, quizIndex.quizId)).toEqual({});
  ...
  test('Multiple Quizzes Deletion from one user, Normal Case', () => {
    ...
    // Now, we remove this quizzes
    expect(adminQuizTrashEmptyRequest(newUser.token, quizIndex1.quizId)).toEqual({});
    expect(adminQuizTrashEmptyRequest(newUser.token, quizIndex2.quizId)).toEqual({});
    expect(adminQuizTrashEmptyRequest(newUser.token, quizIndex3.quizId)).toEqual({});
  ...
  test('Multiple quizzes Deletion with mutiple users, Normal Case', () => {
    ...
    // Now, we remove this quizzes
    expect(adminQuizTrashEmptyRequest(newUser1.token, quizIndex1.quizId)).toEqual({});
    expect(adminQuizTrashEmptyRequest(newUser2.token, quizIndex2.quizId)).toEqual({});
